        ...
        <section className="py-24 bg-[#0D0A08] relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              {/* Cover */}
              <div className="relative w-full max-w-sm aspect-[3/4] rounded-2xl rounded-2xl border border-[#C8A45D]/30 overflow-hidden">
              ...
              <div>
                ...
                <div className="p-5 bg-[#C8A45D]/5 rounded-2xl border border-[#C8A45D]/30">
                  ...
                  <a href="/contacto" className="inline-block mt-3 px-6 py-2 rounded-full bg-[#C8A45D] text-black font-bold text-sm tracking-widest uppercase hover:bg-[#E2C98A] transition-colors">
                    Notifícame
                  </a>
                </div>
              </div>
