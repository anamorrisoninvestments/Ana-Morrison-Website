export const CLIENT = {
  ...
  tagline: "No improvisas la riqueza. La construyes con visión, educación, crédito, estrategia, sistemas y acción constante.",
  taglineEN: "Wealth isn't improvised. It's built with vision, education, credit, strategy, systems, and consistent action.",
...
AnaMaria Morrison representa una nueva generación de mujeres empresarias latinas: visionarias, estratégicas, elegantes y decididas a crear riqueza con propósito.`,
  ...
  stats: [
    ...
    { value: "5", label: "Rutas hacia la riqueza" },
    { value: "$MM", label: "Portafolio inmobiliario" },
  ],

  countries: ["Estados Unidos", "México", "Colombia", "Venezuela"],

  services: [
    {
      title: "Co-Hosting",
      description: "Administración profesional de tu propiedad en plataformas de alquiler a corto plazo.",
    },
    {
      title: "Co-Living",
      description: "Estrategias de co-living para maximizar ingresos por habitación.",
    },
    {
      title: "Arbitraje",
      description: "Opera propiedades sin ser dueño y genera ingresos desde el primer mes.",
    },
    {
      title: "Tax Deeds",
      description: "Adquisición de propiedades mediante subastas del condado con títulos directos.",
    },
    {
      title: "Compra & Construcción",
      description: "Estrategias de adquisición y desarrollo de propiedades para alquiler a corto plazo.",
    },
    {
      title: "Mentoría 1:1",
      description: "Acompañamiento personalizado para inversionistas que quieren crecer su portafolio.",
    },
  ],

  books: [
    {
      slug: "la-ruta-de-la-riqueza",
      coAuthor: undefined as string | undefined,
      title: "La Ruta de la Riqueza con el Alquiler a Corto Plazo",
      titleEN: "The Wealth Route with Short-Term Rentals",
      description:
        "El mapa completo para construir ingresos y libertad financiera a través del alquiler a corto plazo. Metodología probada con 9+ años de experiencia real.",
      descriptionEN:
        "The complete roadmap to building income and financial freedom through short-term rentals. A proven methodology backed by 9+ years of real experience.",
      status: "En proceso de publicación",
      statusEN: "Upcoming",
      cover: "/images/book-ruta-riqueza.jpg",
      topics: ["Airbnb", "Booking", "Arbitraje", "Co-hosting", "Tax Deeds", "Libertad financiera"],
    },
    {
      slug: "crea-tu-suerte",
      title: "Crea tu Suerte",
      titleEN: "Create Your Luck",
      description:
        "Escrito en coautoría con Spencer Hoffmann. Explora el poder de la identidad, la visión, la disciplina y la coherencia como principios para diseñar una vida extraordinaria.",
      descriptionEN:
        "Co-authored with Spencer Hoffmann. Explores the power of identity, vision, discipline, and coherence as principles for designing an extraordinary life.",
      status: "En proceso de publicación",
      statusEN: "Upcoming",
      cover: "/images/book-crea-tu-suerte.jpg",
      coAuthor: "Spencer Hoffmann",
      topics: ["Mentalidad", "Identidad", "Visión", "Disciplina", "Coherencia", "Liderazgo"],
    },
  ],
  ...
  faq: {
    ...
    libros: [
      ...
      {
        q: "¿Qué aprenderé en 'La Ruta de la Riqueza'?",
        a: "Aprenderás las cinco rutas probadas para generar riqueza con alquileres a corto plazo: co-hosting, co-living, arbitraje, compra y construcción, con metodología paso a paso basada en 9+ años de experiencia real.",
      },
      {
        q: "¿Qué es 'Crea tu Suerte' y con quién está escrito?",
        a: "'Crea tu Suerte' es un libro coescrito con el autor y conferencista Spencer Hoffmann. Explora cómo la identidad, la visión, la disciplina y la coherencia son los principios fundamentales para diseñar una vida extraordinaria.",
      },
    ],
    sobreMi: [
      {
